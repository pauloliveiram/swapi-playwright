...
test('Validar o endpoint GET /films', async ({ request }) => {
  ...
  expect(responseBody.results[0].characters[0]).toContain('https://swapi.dev/api/people/');
  expect(Array.isArray(responseBody.results[0].planets)).toBe(true);
  expect(responseBody.results[0].planets[0]).toContain('https://swapi.dev/api/planets/');
  ...
  expect(responseBody.results[0].vehicles[0]).toContain('https://swapi.dev/api/vehicles/');
  expect(Array.isArray(responseBody.results[0].species)).toBe(true);
  expect(responseBody.results[0].species[0]).toContain('https://swapi.dev/api/species/');
